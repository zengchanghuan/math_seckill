...
- **LaTeX 渲染**：flutter_math_fork 0.7.2
- **开发语言**：Dart 3.9.2
...
使用 `flutter_math_fork` 库进行 LaTeX 数学公式渲染：

- 支持完整的 LaTeX 语法
- 高质量数学公式渲染
- 支持行内和块级公式（MathStyle.text 和 MathStyle.display）
- 可自定义文本样式和大小
...
- [x] 集成 flutter_math_fork 以获得更好的 LaTeX 渲染
- [ ] 扩展题库，添加更多题目和公式
- [ ] 添加题目收藏功能
- [ ] 实现学习计划和每日练习提醒
- [ ] 添加动画效果和 UI 优化
...
### 权限和隐私相关
- [ ] **网络权限**：配置网络访问权限（如需要在线同步数据）
- [ ] **个人信息保护**：完善用户隐私保护政策，确保用户数据安全
- [ ] **广告跟踪提醒**：如需集成广告，添加广告跟踪权限说明和用户选择
- [ ] **推送通知**：实现推送通知功能，用于学习提醒和重要更新

### 技术优化
- [x] ~~升级 Flutter SDK 到 3.13+ 并使用 flutter_math_fork 或 flutter_tex 库~~（已完成：已升级到 3.35.6 并使用 flutter_math_fork）
